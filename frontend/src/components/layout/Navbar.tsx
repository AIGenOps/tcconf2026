        ...
        >
          ...
          <Link href="/" className="flex items-center group">
            <div className="relative flex items-center">
              <svg className="w-10 h-8 text-thunder-cyan transition-transform duration-300 group-hover:scale-105 drop-shadow-[0_0_8px_rgba(0,240,255,0.3)]" viewBox="0 0 873 657" fill="currentColor">
            ...
            {navLinks.map((link, idx) => {
              ...
              return (
                <Link
                  ...
                  className={`relative px-4 py-2 text-xs font-medium tracking-widest uppercase transition-colors duration-300 ${
            ...
            <div className="flex flex-col space-y-6 max-w-md mx-auto w-full">
              {navLinks.map((link, idx) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="block text-2xl font-bold tracking-widest uppercase text-slate-300 hover:text-thunder-cyan transition-colors"
                  >
                    {link.name}
                  </Link>
                </motion.div>
