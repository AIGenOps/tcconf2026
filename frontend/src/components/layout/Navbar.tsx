    ...
    <>
      ...
      <div className="fixed top-6 left-6 md:left-10 z-50">
        <Link href="/" className="flex items-center group">
          <svg className="h-8 w-auto text-thunder-cyan transition-transform duration-300 group-hover:scale-105 drop-shadow-[0_0_8px_rgba(0,240,255,0.3)]" viewBox="0 0 873 657" fill="currentColor">
